...
def auto_md_to_docx(file_dir):
    ...
    for file_info in all_whole_path_files:
        ...
        # docx_file_name = file_info[1][:-3] + '.html'
        docx_file_path_file=file_info[0] + "output/" + docx_file_name
        new_command = 'pandoc ' + md_file_path_file + ' -o ' + docx_file_path_file
        # new_command="pandoc --standalone --self-contained --css C:\\Users\\Administrator\\Desktop\\淮安大屏\\中电子\\md.css "+md_file_path_file+" --output " +docx_file_path_file
...
if __name__ == '__main__':
    auto_md_to_docx("C:\\Users\\Administrator\\Desktop\\淮安大屏\\homeDate")
