class Array2D:
    ...
    def __init__(self, w, h):
        ...
        self.h = h
        self.data = []
        self.data = [[" " for y in range(h)] for x in range(w)]
...
if __name__ == '__main__':
    ...
    map2d[4][0:10] = ["[" for _ in range(0,10)]

    map2d[10][10:19] = ["[" for _ in range(10,20)]


    # 显示地图当前样子
    map2d.showArray2D()
    # 创建AStar对象,并设置起点为0,0终点为9,0
    aStar = AStar(map2d, Point(0, 0), Point(16, 15),passTag=" ")
    # 开始寻路
    pathList = aStar.find_path()
    # 遍历路径点,在map2d上以'8'显示
